            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p> 
                  Codigo de produccion: {{ $denegado->cod_orden_produccion }}
                  <p>
                  Usuario de cumplimiento: {{ $denegado->produccion->usuario->str_nombres }} {{ $denegado->produccion->usuario->str_apellidos }}.
                  <p>
                  Empleado: {{ $denegado->produccion->operario->str_nombres }} {{ $denegado->produccion->operario->str_apellidos }}.
                  <p>
